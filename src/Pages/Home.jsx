...
function Home() {
  return (
    <div className=' bg-gradient-to-b from-gray-950 to-black w-full h-screen border-b-2 border-gray-500'>
        <div className='max-w-screen-lg mx-auto flex  items-center flex-col-reverse justify-center h-full px-4 md:flex-row md:pt-14'>
            <div className='flex flex-col justify-center h-full pl-4 sm:pl-0'>
                <h2 className='text-amber-400 text-4xl sm:text-5xl font-bold'>A Passionate Frontend Developer</h2>
                <p className='py-5 pr-16'>
          ...
          <figure className='pt-20 md:pt-0'>
            ...
            className='rounded-2xl mx-auto w-2/3 md:w-full mt-10 md:mt-0' />
          </figure>
